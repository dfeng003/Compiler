...
/**
 * @ast node
 * @declaredat C:\\a.SCHOOL\\yr3sem1\\Compilers\\lab4\\SimpliC_rx2\\src\\jastadd\\lang.ast:20
 * @astdecl Func_call_stmt : Stmt ::= IdCall Expr*;
 * @production Func_call_stmt : {@link Stmt} ::= <span class="component">{@link IdCall}</span> <span class="component">{@link Expr}*</span>;

 */
public class Func_call_stmt extends Stmt implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat C:\\a.SCHOOL\\yr3sem1\\Compilers\\lab4\\SimpliC_rx2\\src\\jastadd\\PrettyPrint.jrag:154
   */
  ...
  public Func_call_stmt(IdCall p0, List<Expr> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public Func_call_stmt clone() throws CloneNotSupportedException {
    Func_call_stmt node = (Func_call_stmt) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:42
   */
  public Func_call_stmt copy() {
    try {
      Func_call_stmt node = (Func_call_stmt) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  @Deprecated
  public Func_call_stmt fullCopy() {
   ...
   */
  public Func_call_stmt treeCopyNoTransform() {
    Func_call_stmt tree = (Func_call_stmt) copy();
    if (children != null) {
   ...
   */
  public Func_call_stmt treeCopy() {
    Func_call_stmt tree = (Func_call_stmt) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
...
protected boolean isInt_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat C:\\a.SCHOOL\\yr3sem1\\Compilers\\lab4\\SimpliC_rx2\\src\\jastadd\\TypeAnalysis.jrag:139
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="C:\\a.SCHOOL\\yr3sem1\\Compilers\\lab4\\SimpliC_rx2\\src\\jastadd\\TypeAnalysis.jrag:139")
  public boolean isInt() {
    ...
    if (isInt_visited) {
      throw new RuntimeException("Circular definition of attribute Func_call_stmt.isInt().");
    }
    isInt_visited = true;
  ...
  public int Define_callParaNum(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getIdCallNoTransform()) {
      // @declaredat C:\\a.SCHOOL\\yr3sem1\\Compilers\\lab4\\SimpliC_rx2\\src\\jastadd\\NameAnalysis.jrag:30
      {
      		return getNumExpr();
      	}
    }
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat C:\\a.SCHOOL\\yr3sem1\\Compilers\\lab4\\SimpliC_rx2\\src\\jastadd\\Errors.jrag:137
    if (!isInt()) {
      {
